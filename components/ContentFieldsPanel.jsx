...
function ContentFieldsPanel({idPrefix,postType,content,heroRegister,eyebrow,pill,deadRoles=[],switchLayoutId,onField,onSwitchLayout,palette:B,fonts:F}){
  ...
  return <>
    ...
    {postType==="event"&&<>{input("headline","Event title",100,{role:"hero",id:idPrefix,markers:true})}{input("dateText","Date (e.g. 15 January)",50,{role:"date",mt:true})}{input("subtext","Details / CTA",180,{role:"support",mt:true})}</>}
