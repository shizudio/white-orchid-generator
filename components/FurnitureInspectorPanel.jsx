...
function FurnitureInspectorPanel({elementKey,type,overrides={},onUpdate,palette:B,fonts:F}){
  ...
  return <>
    <div style={{fontSize:11,color:B.ash,fontFamily:F.body,lineHeight:1.5,marginBottom:12}}>A small editorial detail of this layout. Recolour it, {isLine?"resize it, ":""}or use Delete above to remove it.</div>
