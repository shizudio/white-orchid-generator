...
const EXPECTED_CONSOLE = /(?:net::)?ERR_(CONNECTION_REFUSED|CONNECTION_RESET|ABORTED|FAILED|EMPTY_RESPONSE|NETWORK_CHANGED|TIMED_OUT)|higgsfield|\/api\/(feed-photo|images|design-generate|moodboard|logo-variants|overlay-assets|brand-assets)\b/i;
