...
export function evaluateRenderContracts({
  ...
  textMetrics,
  deadRoles,
  // (Client ruling 2026-07-26) Roles the painter kept VISIBLE past the layout's capacity.
  overCapacityRoles = [],
  mediaSource = {},
  logoEvidence,
  surfaceEvidence = {},
  ...
  const contentTypography = evaluateContentTypographyContract(
    ...
    { width, height, roleBounds, textMetrics, droppedRoles: deadRoles, overCapacityRoles },
  );
