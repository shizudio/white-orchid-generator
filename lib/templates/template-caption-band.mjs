...
export const TEMPLATE_CAPTION_BAND = assertValidTemplate({
  ...
  slots: {
    ...
    pill: {
      ...
      dimensions: {
        portrait:  { present: true, required: false, maxLines: 1, charBudget: MEASURED_BUDGETS.pill.portrait,  box: { x: 0.06, y: 0.8363, w: 0.70, h: 0.10370 } },
        story:     { present: true, required: false, maxLines: 1, charBudget: MEASURED_BUDGETS.pill.story,     box: { x: 0.06, y: 0.8230, w: 0.70, h: 0.07292 } },
        square:    { present: true, required: false, maxLines: 1, charBudget: MEASURED_BUDGETS.pill.square,    box: { x: 0.06, y: 0.8104, w: 0.70, h: 0.12963 } },
    ...
    logo: {
      ...
      dimensions: {
        portrait:  { present: true, required: false, box: { x: 0.81, y: 0.8480, w: 0.12, h: 0.080 }, widthFrac: 0.12, pad: 0.04 },
        story:     { present: true, required: false, box: { x: 0.81, y: 0.8315, w: 0.12, h: 0.056 }, widthFrac: 0.12, pad: 0.04 },
        square:    { present: true, required: false, box: { x: 0.81, y: 0.8252, w: 0.12, h: 0.100 }, widthFrac: 0.12, pad: 0.04 },
        landscape: { present: true, required: false, box: { x: 0.87, y: 0.7500, w: 0.08, h: 0.119 }, widthFrac: 0.08, pad: 0.04 },
      },
    },
  },
