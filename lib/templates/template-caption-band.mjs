...
export const TEMPLATE_CAPTION_BAND = assertValidTemplate({
  ...
  allowedLogoPositions: ['top-right'], // landscape's left column is the photograph — top-left has no field to sit on
  ...
  slots: {
    ...
    heading: {
      ...
      dimensions: {
        portrait:  { present: true, required: false, maxLines: 2, charBudget: MEASURED_BUDGETS.heading.portrait,  box: { x: 0.06, y: 0.7150, w: 0.88, h: 0.14204 } },
        ...
        square:    { present: true, required: false, maxLines: 2, charBudget: MEASURED_BUDGETS.heading.square,    box: { x: 0.06, y: 0.6610, w: 0.88, h: 0.17756 } },
    ...
    pill: {
      ...
      dimensions: {
        portrait:  { present: true, required: false, maxLines: 1, charBudget: MEASURED_BUDGETS.pill.portrait,  box: { x: 0.06, y: 0.8700, w: 0.88, h: 0.10370 } },
        story:     { present: true, required: false, maxLines: 1, charBudget: MEASURED_BUDGETS.pill.story,     box: { x: 0.06, y: 0.8230, w: 0.88, h: 0.07292 } },
        square:    { present: true, required: false, maxLines: 1, charBudget: MEASURED_BUDGETS.pill.square,    box: { x: 0.06, y: 0.8500, w: 0.88, h: 0.12963 } },
        landscape: { present: true, required: false, maxLines: 1, charBudget: MEASURED_BUDGETS.pill.landscape, box: { x: 0.46, y: 0.5400, w: 0.48, h: 0.12963 } },
      },
    },
    ...
    photo: {
      ...
      dimensions: {
        portrait:  { present: true, required: true, fit: 'cover', box: { x: 0.05, y: 0.185, w: 0.90, h: 0.505 } },
        story:     { present: true, required: true, fit: 'cover', box: { x: 0.05, y: 0.135, w: 0.90, h: 0.545 } },
        square:    { present: true, required: true, fit: 'cover', box: { x: 0.05, y: 0.235, w: 0.90, h: 0.405 } },
        landscape: { present: true, required: true, fit: 'cover', box: { x: 0.05, y: 0.060, w: 0.37, h: 0.880 } },
      },
    },
    ...
    logo: {
      ...
      dimensions: {
        portrait:  { present: true, required: false, box: { x: 0.79, y: 0.040, w: 0.12, h: 0.080 }, widthFrac: 0.12, pad: 0.09 },
        story:     { present: true, required: false, box: { x: 0.79, y: 0.030, w: 0.12, h: 0.056 }, widthFrac: 0.12, pad: 0.09 },
        square:    { present: true, required: false, box: { x: 0.79, y: 0.045, w: 0.12, h: 0.072 }, widthFrac: 0.12, pad: 0.09 },
        landscape: { present: true, required: false, box: { x: 0.85, y: 0.080, w: 0.08, h: 0.119 }, widthFrac: 0.08, pad: 0.09 },
      },
    },
  },
