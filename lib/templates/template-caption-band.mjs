...
export const TEMPLATE_CAPTION_BAND = assertValidTemplate({
  ...
  purpose: 'A photograph with an announcement under it: a quiet line, then a few big words in capitals, on a calm colour band with the brand petal ghosted into it. The mark sits on the picture. A photo is required. Best when you have one thing to say and a picture to say it over.',
  ...
  slots: {
    ...
    motif: {
      ...
      asset: 'petal-brand',
      dimensions: {
        portrait:  { present: true, required: false, opacity: 0.10, box: { x: 0.6986, y: 0.7437, w: 0.27917, h: 0.22222 } },
        story:     { present: true, required: false, opacity: 0.10, box: { x: 0.6986, y: 0.6967, w: 0.27917, h: 0.15625 } },
        square:    { present: true, required: false, opacity: 0.10, box: { x: 0.6986, y: 0.6985, w: 0.27917, h: 0.27778 } },
        landscape: { present: true, required: false, opacity: 0.09, box: { x: 0.8117, y: 0.3556, w: 0.16331, h: 0.28889 } },
      },
    },
