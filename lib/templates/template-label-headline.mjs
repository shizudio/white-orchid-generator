...
export const TEMPLATE_LABEL_HEADLINE = assertValidTemplate({
  ...
  slots: {
    ...
    logo: {
      ...
      dimensions: {
        portrait:  { present: true, required: false, box: { x: 0.73, y: 0.90, w: 0.22, h: 0.08 }, heightFrac: 0.090, pad: 0.05 },
        story:     { present: true, required: false, box: { x: 0.73, y: 0.92, w: 0.22, h: 0.06 }, heightFrac: 0.090, pad: 0.05 },
        square:    { present: true, required: false, box: { x: 0.73, y: 0.87, w: 0.22, h: 0.10 }, heightFrac: 0.090, pad: 0.05 },
        landscape: { present: true, required: false, box: { x: 0.80, y: 0.78, w: 0.16, h: 0.14 }, heightFrac: 0.0625, pad: 0.05 },
      },
    },
  },
