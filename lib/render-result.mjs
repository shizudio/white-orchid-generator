...
export function createRenderResult({ dimensionId, width, height, textBounds, roleBounds = {}, logoBox, photoBox, subjectBox, shapes = [], deadRoles = [], textMetrics = {}, contrast = null, auditSignal = null, findings = [], constraints = null, contentTypography = null, mediaLogo = null, surface = null, decoration = null }) {
  const sceneElements=[];
