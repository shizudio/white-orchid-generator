...
const AUDIT_COPY_FIELDS = ['headline', 'subtext', 'attribution', 'dateText', 'microLabel', 'pillText', 'imagePrompt', 'scenePrompt'];
...
export const CLIENT_PATCH_KEYS = [
  'bgAlpha', 'textLayout', 'photoTransform', 'overlayUpdate', 'removeOverlay',
  'imageSrc', 'removeImage', 'archVariant',
];
