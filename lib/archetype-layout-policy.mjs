...
// (Task #69 — ALWAYS LOGO, client ruling 2026-08-17: "i want there to be always
// logo, currently some generations dont have logo by default.") The brand mark is
// REQUIRED CONTENT on every fresh generation. Archetypes still AUTHOR a logoUse
// preference, but the resolver is TOTAL: the retired "none"/"url" restraint (the
// old feed-reference minimalism) and any unknown/absent value all resolve to the
// quiet corner "mark"; only an explicit "lockup" keeps the full lockup. An
// explicit USER removal remains a pin the render honors (law 5) — this governs
// only what a generation BIRTHS with.
export function resolveLogoDrawClass(logoUse) {
  return logoUse === "lockup" ? "lockup" : "mark";
}
