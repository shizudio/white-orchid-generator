...
// ── SHAPE DISPLAY NAMES (client ruling 2026-08-18) ───────────────────────────
// The Shapes row presents the built-in Shape 1/2/3 as "Petal 1/2/3" and the
// uploaded orchid line drawing (stored name "image 1") as "Motif 1". IDS STAY
// STABLE — stored designs and the PATCH_OPTIONS.overlayAssetId enum are
// untouched; this is presentation only, resolved by
// lib/overlay-shapes.mjs displayOverlayName() wherever a shape name renders.
// Keyed maps live HERE because they are brand facts (law 7).
export const OVERLAY_DISPLAY_NAMES = {
  'shape-1': 'Petal 1',
  'shape-2': 'Petal 2',
  'shape-3': 'Petal 3',
};
// Uploaded/official assets have no stable slug in code (their id is a storage
// path), so their presentation names key on the stored asset NAME (lowercase).
export const UPLOAD_DISPLAY_NAMES = {
  'image 1': 'Motif 1',
};
