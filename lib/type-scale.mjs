...
export const TYPE_SCALE = Object.freeze({
  tall: Object.freeze({
    legacy: Object.freeze({ xs: 0.64, s: 0.78, m: 1.0, l: 1.34, xl: 1.64 }),
    element: Object.freeze({ S: 0.78, M: 1.0, L: 1.34 }),
  }),
  square: Object.freeze({
    legacy: Object.freeze({ xs: 0.66, s: 0.8, m: 1.0, l: 1.28, xl: 1.56 }),
    element: Object.freeze({ S: 0.8, M: 1.0, L: 1.28 }),
  }),
  wide: Object.freeze({
    legacy: Object.freeze({ xs: 0.7, s: 0.82, m: 1.0, l: 1.24, xl: 1.46 }),
    element: Object.freeze({ S: 0.82, M: 1.0, L: 1.24 }),
  }),
});
